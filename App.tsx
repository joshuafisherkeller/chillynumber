...
const App: React.FC = () => {
    ...
    const handleGetNumber = () => {
        ...
        setTimeout(() => {
            ...
            // Randomly decide whether to briefly show 46 before landing on 47
            const showTeaser = Math.random() > 0.4; // 60% chance to show the teaser
